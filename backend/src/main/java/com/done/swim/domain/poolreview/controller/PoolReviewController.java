...
public class PoolReviewController {
  ...
  public ResponseEntity<ApiResponse<getReviewBeforeDateResponseDto>> getReviewBeforeDate(
      @PathVariable Long reviewId,
      @AuthenticationPrincipal User user
  ) {
    System.out.println("test");

    getReviewBeforeDateResponseDto getReviewBeforeDate = poolReviewService.getReviewBeforeDate(
        reviewId, user.getId());
