  ...
  return (
    <div className="flex justify-center">
      <button
        ...
        className="min-w-[180px] font-semibold flex items-center bg-kyello text-black rounded-md px-40 py-4 gap-3 mb-2"
      >
        <svg
        ...
        <span className="leading-normal">카카오로 계속하기</span>
      </button>
    </div>
  );
}
